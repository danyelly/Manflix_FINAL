    ...
    <div class="conteudo">
        ...
        <div class="divForm">
          <form class="formCad">
            ...
            <InputText placeholder="CPF" v-model="user.cpf"/>
            <InputText placeholder="Birth" v-model="user.bday"/>
            <InputText type="email" placeholder="Email" v-model="user.email"/>
            <InputText placeholder="Phone" v-model="user.phone"/>
            <InputText type="file" placeholder="Photo" v-model="user.photo"/>
  ...
  methods:{
    ...
    registerUsuarios: async function () {
      const body = [{
        ...
        cpf: this.user.cpf,
        nascimento: this.user.bday,
        email: this.user.email,
        fone: this.user.phone,
        foto: this.user.photo,
        idUserFK: this.user.idUser,
        idAssinaturaFK: this.assinatura
      }];
